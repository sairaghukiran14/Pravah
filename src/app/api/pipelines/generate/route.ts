...
5. You MUST respond in the same language as the user's request. If the user describes their pipeline in English, your "message" response, the generated pipeline "name", pipeline "description", and node "label" properties MUST be in English. If they use Hindi, use Hindi, and so on. Do not mix or respond in Hindi when the user prompts in English.
