        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-2">
            <Link href="/" className="hover:opacity-85 transition-opacity flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="text-lg sm:text-xl font-normal tracking-tight text-gray-900 leading-none">pravah</span>
            </Link>
          ...
          <div className="text-center mb-10">
            <div className="lg:hidden mb-6">
              <Link href="/" className="hover:opacity-85 transition-opacity flex items-center justify-center gap-1.5">
                <img src="/logo.png" alt="pravah logo" className="h-6 w-6 object-contain" />
                <h1 className="text-3xl font-normal tracking-tight text-gray-900 leading-none">pravah</h1>
              </Link>
